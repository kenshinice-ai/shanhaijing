...
- 生成时间：`2026-08-19T10:53:39.909Z`
- 数据库：`shanhaijing_atlas`（PostgreSQL 18.6 (Homebrew)）
- 证据层级：`local_candidate`
- 检查结果：`pass`（1169 检查，0 错误）

## 三项独立统计

- unique creature concepts：85
- textual occurrences：88
- corpus coverage：43/125

## Findings

- [info] edition-scope: 底本范围：nanshan（1 个版本）、xishan（1 个版本）
- [info] TAXONOMY-VOCABULARY: 分类词表：8 轴、72 词条，覆盖 44 组已发布指派
