...
- 全部产物：12 个文件，579.0 KB（brotli 123.9 KB）
- 首屏必需集：483.1 KB（brotli 105.6 KB）—— assets/index-DXAZ8B5p.js、assets/index-K4dRpTAB.css、data/atlas.shanhaijing.zh-CN.json、index.html、media/shanhaijing/artistic-overview-v1.svg

| 文件 | 原始 | gzip | brotli |
|---|---|---|---|
| `404.html` | 1.6 KB | 0.9 KB | 0.7 KB |
| `assets/index-DXAZ8B5p.js` | 294.8 KB | 89.6 KB | 77.6 KB |
| `assets/index-K4dRpTAB.css` | 21.4 KB | 5.5 KB | 4.8 KB |
| `data/atlas.shanhaijing.en.json` | 87.6 KB | 16.6 KB | 12.3 KB |
| `data/atlas.shanhaijing.zh-CN.json` | 85.3 KB | 15.8 KB | 11.8 KB |
...
|---|---|---|---|---|
| zh-CN | 85.3 KB | 0.12 / 0.13 ms | 0.14 / 0.23 ms | 0 ms |
| en | 87.6 KB | 0.12 / 0.13 ms | 0.13 / 0.17 ms | 0.01 ms |
